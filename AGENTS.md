...
* When refactoring or generating code, prefer vectorizable code.
...
- Ensure benchmark scenarios are bounded to practical sizes to avoid excessive CI runtime while preserving baseline coverage.
